...
function BackgroundAlignment(props) {
    ...
    return(
        ...
        <form className="character-form-name" onSubmit={submitHandler}>
            ...
            <p className="description-background">{descriptionSwitch(background)}</p>
            
            <div className="button-box">
                    <button className="back-button" type="button" onClick={props.changeComponentsBack4}>Back</button>
