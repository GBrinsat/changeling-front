      ...
      {user ? (
        <>
          ...
          <div className="character-form">
            <h1>
              Welcome {user.name.slice(0, 1).toUpperCase() + user.name.slice(1)}
              !
            </h1>
            <p className="character-creation-text-start">
              Here you can find your characters:
            </p>
        ...
        <>
          <div className="character-form">
            ...
            <p className="character-creation-text-start login-text">
              Join us and jump right into creating Dungeons & Dragons characters
