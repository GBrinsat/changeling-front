...
function CharacterSheetEdit() {
  ...
  function submitHandler(e) {
    ...
    axios
      .put(
        `${import.meta.env.VITE_API_URL}/character/update/${character._id}`,
        body,
        { headers: { Authorization: `Bearer ${storedToken}` } }
      )
      .then(() => {
        ...
        axios
          .put(
            `${import.meta.env.VITE_API_URL}/backstory/${
              character.backstory[0]
            }`,
            body,
            { headers: { Authorization: `Bearer ${storedToken}` } }
          )
        ...
        <>
          ...
          <form className="character-form-name" onSubmit={submitHandler}>
            ...
            <select
              className="character-creation-select"
              name="playerclass"
              onChange={handlePlayerClassChange}
            >
              <option value="" disabled selected>
                {character.class}
              </option>
            ...
            <div className="edit-box-small">
              <div className="edit-sheet-card">
                ...
                <input
                  ...
                  type="text"
                  placeholder={character.armorclass}
              ...
              <div className="edit-sheet-card">
                ...
                <div className="input-field">
                  ...
                  <input
                    className="edit-input"
                    type="text"
                    placeholder={character.hpcurrent}
